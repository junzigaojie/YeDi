...
public class SearchViewHolder {
     ...
     * init holder
     */
    public SearchViewHolder(Context context, int layoutId, ViewGroup parent, int position) {
     ...
     *  获取viewHolder
     */
    public static SearchViewHolder getHolder(Context context, View convertView,
                                       int layoutId, ViewGroup parent, int position) {
        if(convertView == null){
            return new SearchViewHolder(context,layoutId,parent,position);
        }else{
