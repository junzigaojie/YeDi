...
import com.yedi.app.tools.DbFinal;
...
public class MusicDBHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_LOCALMUSIC="CREATE TABLE IF NOT EXISTS " + DbFinal.TABLE_LOCALMUSIC
            + " (" + DbFinal.LOCAL_ID
            ...
            + DbFinal.SING_ID + " TEXT,"
            + DbFinal.IS_HISTORY +" TEXT,"
            + DbFinal.IS_DOWNLOAD +" TEXT,"
            + DbFinal.LOCAL_ALBUM_IMG_PATH + " TEXT" + ");";

    private static final String CREATE_FAVORITES="CREATE TABLE IF NOT EXISTS " + DbFinal.TABLE_FAVORITES
            + " (" + DbFinal.FAVORITES_ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + DbFinal.FAVORITES_LOCAL_ID + " INTEGER UNIQUE NOT NULL);";

    private static final String CREATE_ARTIST="CREATE TABLE IF NOT EXISTS " + DbFinal.TABLE_ARTIST + " ("
            + DbFinal.ARTIST_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + DbFinal.ARTIST_LOCAL_ARTIST + " TEXT UNIQUE NOT NULL);";

    private static final String CREATE_ALBUM="CREATE TABLE IF NOT EXISTS " + DbFinal.TABLE_ALBUM + " ("
    ...
    //根据songID查询本地音乐库
    public Cursor queryLocalBySongID(String Song_ID) {
        Cursor cur=db.rawQuery("select * from "+DbFinal.TABLE_LOCALMUSIC+" where "+DbFinal.SING_ID+" =?",new String[]{Song_ID});
        return cur;
    }
